 ...
 * noki-api (POST /v1/admin/commerce/fulfillment/tasks/{id}/qc) but the QC
 * workspace UI is out of scope for this pass -- see
 * src/domains/registry.ts.
 */
export default async function QcPage({ params }: PageProps) {
